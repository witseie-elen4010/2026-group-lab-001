...
const registerCompleteRouter = require('./routes/register_complete')
...
const { router: dailySummaryRouter } = require('./routes/daily_summary')
...
app.use('/register/complete', registerCompleteRouter)
...
app.use('/daily_summary', requireAuthentication, dailySummaryRouter)
